# metallb/metallb 0.16.1 Proof

This is the exact-artifact ConfigHub component package for the metallb@0.16.1 dependency selected by Kubara catalogs 1.1.0.
