# oauth2-proxy/oauth2-proxy 10.7.0 Proof

This is the exact-artifact ConfigHub component package for the oauth2-proxy@10.7.0 dependency selected by Kubara catalogs 1.1.0.

Variants:

- `default`: chart defaults; 5 Helm objects, 6 cub installer objects including Namespace.
