# grafana/alloy 1.11.0 Proof

This is the exact-artifact ConfigHub component package for the alloy@1.11.0 dependency selected by Kubara catalogs 1.1.0.

Variants:

- `default`: chart defaults; 7 Helm objects, 8 cub installer objects including Namespace.
