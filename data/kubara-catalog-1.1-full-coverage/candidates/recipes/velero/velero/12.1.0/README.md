# velero/velero 12.1.0 Proof

This is the exact-artifact ConfigHub component package for the velero@12.1.0 dependency selected by Kubara catalogs 1.1.0.

Variants:

- `default`: chart defaults; 23 Helm objects, 24 cub installer objects including Namespace.
