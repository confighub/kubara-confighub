# longhorn/longhorn 1.12.0 Proof

This is the exact-artifact ConfigHub component package for the longhorn@1.12.0 dependency selected by Kubara catalogs 1.1.0.
